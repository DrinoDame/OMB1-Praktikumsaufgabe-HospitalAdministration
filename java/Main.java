...
public class Main {
    ...
    public static void main(String[] args) throws PersonNotFoundException, RoomNotFoundException {
        ...
        Doctor tina = new Doctor("Tina", 38, "doctor", 100.0f, 2, tinasTime, Doctor.Degree.Specialist);
        ...
        Nurse paul = new Nurse("Paul", 55, "nurse", 50.0f, 1, paulsTime, Nurse.Shift.nightShift);
        ...
        // Patienten
        Patient tom = new Patient("Tom", 40, "patient", true);
        managementOfTestHospital.persons.add(tom);

        Patient klaus = new Patient("Klaus", 78, "patient", true);
        managementOfTestHospital.persons.add(klaus);

        // nicht gesetzlich versichert
        Patient amy = new Patient("Amy", 36, "patient",false);
